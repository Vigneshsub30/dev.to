# Forem API V1 MCP Server

This MCP (Model Content Protocol) server provides access to Forem API V1 API functionality through HTTP, HTTPS, and STDIO transport modes.
