...
func VideosHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/videos%s", cfg.BaseURL, queryString)
...
func CreateVideosTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_videos",
		mcp.WithDescription("Articles with a video"),
