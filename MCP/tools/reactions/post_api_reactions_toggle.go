...
func Post_api_reactions_toggleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/reactions/toggle%s", cfg.BaseURL, queryString)
...
func CreatePost_api_reactions_toggleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_reactions_toggle",
		mcp.WithDescription("toggle reaction"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_api_reactions_toggleHandler(cfg),
	}
}
