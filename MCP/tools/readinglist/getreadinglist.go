...
func GetreadinglistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/readinglist%s", cfg.BaseURL, queryString)
...
func CreateGetreadinglistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_readinglist",
		mcp.WithDescription("Readinglist"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetreadinglistHandler(cfg),
	}
}
