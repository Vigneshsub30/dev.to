...
func GetuserpublishedarticlesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/articles/me/published%s", cfg.BaseURL, queryString)
...
func CreateGetuserpublishedarticlesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_articles_me_published",
		mcp.WithDescription("User's published articles"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetuserpublishedarticlesHandler(cfg),
	}
}
